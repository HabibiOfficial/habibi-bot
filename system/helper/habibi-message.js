 ...
 * Habibi Bot  ╌  habibi
 * ════════════════════════════════════════════
 * file    : system/helper/habibi-message.js
 * desc    : system › helper › habibi-message
 * author  : Habibi  ⪩  2026
 * ════════════════════════════════════════════
...
export async function habibiSend(
  feb,
  jid,
  payload,
  options = {}
...
export const habibiReply = (
  feb,
  m,
  text,
  opt = {}
) =>
  habibiSend(feb, m.chat, text, {
    ...opt,
    quoted: m
  })
